...
### 6.8 `config.map_edit_operations`
...
### 6.9 `config.map_validation_results`
...
### 6.11 `config.action_definitions`
...
每个 Run 仅一条 CurrentState，使用 `state_version` 乐观更新。
